...
vi.mock('@/features/playback/utils/audio/seekErrors', () => ({ isRecoverableSeekError: hoisted.isRecoverableSeekErrorMock }));
vi.mock('@/features/playback/store/seekTargetState', () => ({ setSeekTarget: hoisted.setSeekTargetMock }));
