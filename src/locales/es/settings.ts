export const settings = {
  ...
  playbackRateStrategyVarispeedSemitones: 'Semitonos',
  playbackRateStrategyPreserve: 'Tono',
  playbackRateStrategySpeedTip: 'Cambia el tempo; el tono se corrige automáticamente.',
  playbackRateStrategyVarispeedTip: 'La velocidad y el tono cambian juntos, como una cinta. Tono según la velocidad: 12 × log2(velocidad).',
  playbackRateStrategyVarispeedSemitonesTip: 'Igual que « Con tono », pero ajustado directamente en semitonos. Velocidad = 2^(st/12).',
  playbackRateStrategyPreserveTip: 'Tempo ajustable más un desplazamiento de tono manual (±12 st).',
  ...
  autodjOverlapCapTitle: 'Límite de solapamiento',
  autodjOverlapCapDesc: 'Limita cuánto pueden solaparse las pistas con AutoDJ. Auto sigue el análisis del contenido (hasta 12 s). Límite fija su propio máximo.',
  autodjOverlapCapAuto: 'Auto',
  autodjOverlapCapLimit: 'Límite',
