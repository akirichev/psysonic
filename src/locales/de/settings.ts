export const settings = {
  ...
  autodjOverlapCapTitle: 'Überlappungslimit',
  autodjOverlapCapDesc: 'Begrenzt, wie lange AutoDJ Titel überlappen darf. Auto folgt der Inhaltsanalyse (bis 12 s). Limit setzt Ihr eigenes Maximum.',
