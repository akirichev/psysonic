export const settings = {
  ...
  playbackRateStrategyVarispeedSemitones: 'Semitonuri',
  playbackRateStrategyPreserve: 'Ton',
  playbackRateStrategySpeedTip: 'Schimbă tempoul; tonul este corectat automat.',
  playbackRateStrategyVarispeedTip: 'Viteza și tonul se schimbă împreună, ca la bandă. Ton în funcție de viteză: 12 × log2(viteză).',
  playbackRateStrategyVarispeedSemitonesTip: 'La fel ca « Cu ton », dar reglat direct în semitonuri. Viteză = 2^(st/12).',
  playbackRateStrategyPreserveTip: 'Tempo reglabil plus o deplasare manuală a tonului (±12 st).',
  ...
  autodjOverlapCapTitle: 'Limită suprapunere',
  autodjOverlapCapDesc: 'Limitează cât pot suprapune piesele cu AutoDJ. Auto urmează analiza conținutului (până la 12 s). Limită setează maximul dvs.',
  autodjOverlapCapAuto: 'Auto',
  autodjOverlapCapLimit: 'Limită',
