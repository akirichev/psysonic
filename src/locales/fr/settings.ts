export const settings = {
  ...
  customHeadersNamePlaceholder: 'Nom de l’en-tête',
  customHeadersValuePlaceholder: 'Valeur de l’en-tête',
  customHeadersAddRow: 'Ajouter un en-tête',
  customHeadersRemoveRow: 'Supprimer l’en-tête',
  ...
  'customHeadersValidation.tooMany': 'Trop d’en-têtes personnalisés (max. 16).',
  'customHeadersValidation.nameRequired': 'Le nom de l’en-tête est requis.',
  'customHeadersValidation.nameTooLong': 'Le nom de l’en-tête est trop long.',
  'customHeadersValidation.valueTooLong': 'La valeur de l’en-tête est trop longue.',
  'customHeadersValidation.crlf': 'Les noms et valeurs ne peuvent pas contenir de saut de ligne.',
  'customHeadersValidation.blocked': 'Ce nom d’en-tête n’est pas autorisé.',
  'customHeadersValidation.duplicate': 'Nom d’en-tête en double.',
  ...
  playbackRateStrategyVarispeedSemitones: 'Demi-tons',
  playbackRateStrategyPreserve: 'Hauteur',
  playbackRateStrategySpeedTip: 'Modifie le tempo ; la hauteur est corrigée automatiquement.',
  playbackRateStrategyVarispeedTip: 'La vitesse et la hauteur changent ensemble, comme une bande. Hauteur selon la vitesse : 12 × log2(vitesse).',
  playbackRateStrategyVarispeedSemitonesTip: 'Comme « Avec hauteur », mais réglé directement en demi-tons. Vitesse = 2^(dt/12).',
  playbackRateStrategyPreserveTip: 'Tempo réglable plus un décalage de hauteur manuel (±12 dt).',
  ...
  autodjOverlapCapTitle: 'Limite de chevauchement',
  autodjOverlapCapDesc: 'Limite la durée de chevauchement AutoDJ. Auto suit l’analyse du contenu (jusqu’à 12 s). Limite fixe votre propre maximum.',
