export const settings = {
  ...
  autodjOverlapCapTitle: 'Overlaplimiet',
  autodjOverlapCapDesc: 'Beperkt hoe lang AutoDJ nummers mag overlappen. Auto volgt inhoudsanalyse (tot 12 s). Limiet stelt uw eigen maximum in.',
  autodjOverlapCapAuto: 'Auto',
  autodjOverlapCapLimit: 'Limiet',
